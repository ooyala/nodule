...
module Nodule
  ...
  class Base
    ...
    #
    # Create a new Nodule actor. This is meant to be a bass class for higher-level
    # Nodule actors.
    #
    ...
    def initialize(opts={})
      ...
      if opts[:readers].respond_to? :each
        opts[:readers].each do |r| add_reader(r) end
      end
    end
    ...
    def _verbose(*out)
      if @verbose.respond_to? :run_readers
        run_readers out.join(' ')
      elsif @verbose
